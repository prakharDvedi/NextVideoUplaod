...
export interface Video {
    ...
    transformations?: { // Optional transformations for the video
        hieght: number; // Height of the video
...
const videoSchema = new mongoose.Schema<Video>(
    {
        ...
        transformations: {
            hieght: { type: Number, default: videoDimentions.HEIGHT, required: true }, // Height with default value
            width: { type: Number, default: videoDimentions.WIDTH, required: true }, // Width with default value
...
1. videoDimentions: Defines constant dimensions for videos.
